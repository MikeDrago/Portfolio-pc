...
const windowContents = {
  ...
  'Terminal': '<div class="terminal" id="terminal"></div>',
...
function createWindow(name, icon, originX, originY) {
  ...
  // se la finestra aperta è il Terminal, avvia l'animazione
  if (name === 'Terminal') {
    const terminalEl = win.querySelector('#terminal');
    runTerminalAnimation(terminalEl);
  }
